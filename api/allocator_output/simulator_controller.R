...
#* @apiTitle Robyn CDS Central Digital team
#* @apiDescription Api build from Robyn Object to simulate difference scenarios
#* @get /robyn_scenarios_endpoint
robyn_scenarios_endpoint <- function(expected_spend, expected_spend_days, 
                                     ShopBack_S_low,ShopBack_S_high,Google.Shopping_S_low,
                                     Google.Shopping_S_high,Google.PFM_S_low,
                                     Google.PFM_S_high,Facebook...DABA_S_low,Facebook...DABA_S_high,
                                     Facebook...DPA_S_low,Facebook...DPA_S_high,Facebook...BAU_S_low,
                                     Facebook...BAU_S_high,Facebook...INS_S_low,Facebook...INS_S_high,
                                     Google.UAC...INS_S_low,Google.UAC...INS_S_high,Criteo_S_low,Criteo_S_high,
                                     Facebook...Branding_S_low,Facebook...Branding_S_high, scenario){

  expected_spend = as.numeric(expected_spend)
  expected_spend_days = as.numeric(expected_spend_days)

  ShopBack_S_low = as.numeric(ShopBack_S_low)
  ShopBack_S_high = as.numeric(ShopBack_S_high)
  Google.Shopping_S_low = as.numeric(Google.Shopping_S_low)
  Google.Shopping_S_high = as.numeric(Google.Shopping_S_high)
  Google.PFM_S_low = as.numeric(Google.PFM_S_low)
  Google.PFM_S_high = as.numeric(Google.PFM_S_high)
  Facebook...DABA_S_low = as.numeric(Facebook...DABA_S_low)
  Facebook...DABA_S_high = as.numeric(Facebook...DABA_S_high)
  Facebook...DPA_S_low = as.numeric(Facebook...DPA_S_low)
  Facebook...DPA_S_high = as.numeric(Facebook...DPA_S_high)
  Facebook...BAU_S_low = as.numeric(Facebook...BAU_S_low)
  Facebook...BAU_S_high = as.numeric(Facebook...BAU_S_high)
  Facebook...INS_S_low = as.numeric(Facebook...INS_S_low)
  Facebook...INS_S_high = as.numeric(Facebook...INS_S_high)
  Google.UAC...INS_S_low = as.numeric(Google.UAC...INS_S_low)
  Google.UAC...INS_S_high = as.numeric(Google.UAC...INS_S_high)
  Criteo_S_low = as.numeric(Criteo_S_low)
  Criteo_S_high = as.numeric(Criteo_S_high)
  Facebook...Branding_S_low = as.numeric(Facebook...Branding_S_low)
  Facebook...Branding_S_high = as.numeric(Facebook...Branding_S_high)
  ...
  AllocatorCollect2 <- robyn_allocator(
    ...
    scenario = scenario,
    channel_constr_low = c(ShopBack_S_low,Google.Shopping_S_low,Google.PFM_S_low,Facebook...DABA_S_low,
                           Facebook...DPA_S_low,Facebook...BAU_S_low,Facebook...INS_S_low,Google.UAC...INS_S_low,
                           Criteo_S_low,Facebook...Branding_S_low),
    channel_constr_up = c(ShopBack_S_high,Google.Shopping_S_high,Google.PFM_S_high,Facebook...DABA_S_high,
                          Facebook...DPA_S_high,Facebook...BAU_S_high,Facebook...INS_S_high,
                          Google.UAC...INS_S_high,Criteo_S_high,Facebook...Branding_S_high),
    expected_spend = expected_spend, # Total spend to be simulated
    expected_spend_days = expected_spend_days, # Duration of expected_spend in days
    export = TRUE
  )
  
  output.mmm <- AllocatorCollect2$dt_optimOut
  ### Select table and building aggreated metrics
  dfe <- output.mmm %>% select(initSpendUnit , optmSpendUnit, initRoiUnit, optmRoiUnit)
  ...
  json_file = ('Robyn_202210192111_init/RobynModel-inputs.json')
...
robyn_plot_object <- list(dfe, plotDT_scurve, plotDT_share, plotDT_resp, dt_optimOut)
print(robyn_plot_object)   

}

# expected_spend=100000000
# expected_spend_days = 10
# scenario = "max_response_expected_spend"
# ShopBack_S_low = 0.7
# Google.Shopping_S_low = 0.7
# Google.PFM_S_low = 0.7
# Facebook...DABA_S_low = 0.7
# Facebook...DPA_S_low = 0.7
# Facebook...BAU_S_low = 0.7
# Facebook...INS_S_low = 0.7
# Google.UAC...INS_S_low = 0.7
# Criteo_S_low = 0.7
# Facebook...Branding_S_low = 0.7
# 
# ShopBack_S_high = 0.7
# Google.Shopping_S_high = 0.7
# Google.PFM_S_high = 0.7
# Facebook...DABA_S_high = 0.7
# Facebook...DPA_S_high = 0.7
# Facebook...BAU_S_high = 0.7
# Facebook...INS_S_high = 0.7
# Google.UAC...INS_S_high = 0.7
# Criteo_S_high = 0.7
# Facebook...Branding_S_high = 0.7
# 
# robyn_scenarios_endpoint(expected_spend, expected_spend_days, 
#                          ShopBack_S_low,ShopBack_S_high,Google.Shopping_S_low,
#                          Google.Shopping_S_high,Google.PFM_S_low,
#                          Google.PFM_S_high,Facebook...DABA_S_low,Facebook...DABA_S_high,
#                          Facebook...DPA_S_low,Facebook...DPA_S_high,Facebook...BAU_S_low,
#                          Facebook...BAU_S_high,Facebook...INS_S_low,Facebook...INS_S_high,
#                          Google.UAC...INS_S_low,Google.UAC...INS_S_high,Criteo_S_low,Criteo_S_high,Facebook...Branding_S_low,
#                          Facebook...Branding_S_high, scenario)
